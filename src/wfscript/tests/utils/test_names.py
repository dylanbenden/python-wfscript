...
from ..content_root_loading import content_root_path, content_root_module, loading_namespace_root
...
def test_path_to_identity():
    expected = 'wfscript.tests.content_root_loading.loading.versioned_method'
